...
//const CGFloat kTopOffset        = 64.f;

@interface MCRefreshControlDefaultContentView : UIView <MCRefreshControlContentView>
...
@interface MCRefreshControlDefaultContentView ()
{
...
@implementation MCRefreshControlDefaultContentView
...
@interface MCRefreshControl ()
{
    UIView<MCRefreshControlContentView> *_contentView;
...
@implementation MCRefreshControl
...
- (id)initInScrollView:(UIScrollView *)scrollView activityIndicatorView:(UIView *)activity
{
    ...
    if (self) {
        ...
        _contentView = [[MCRefreshControlDefaultContentView alloc] initWithFrame:self.bounds activityIndicatorView:activity];
