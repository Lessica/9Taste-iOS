...
const float MCInitialProgressValue = 0.1f;
const float MCInteractiveProgressValue = 0.5f;
const float MCFinalProgressValue = 0.9f;

@implementation MCWebViewProgress
{
...
- (void)startProgress
{
    if (_progress < MCInitialProgressValue) {
        [self setProgress:MCInitialProgressValue];
    }
}
...
- (void)incrementProgress
{
    ...
    float maxProgress = _interactive ? MCFinalProgressValue : MCInteractiveProgressValue;
